...
<head>
	...
	<style>
		...
		:root {
			...
			--button-on-surface-hover: #000000;
			--button-on-surface: #444444;
		...
		html.dark-theme {
			...
			--button-on-surface-hover: #FFFFFF;
			--button-on-surface: #AAAAAA;
			--button-surface-hover: #444444;
			--button-surface: #333333;
			--focused-outline: #7C8DC7;
			--on-surface-primary: #FFFFFF;
			--on-surface-secondary: #CCCCCC;
