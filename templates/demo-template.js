...
function generateDemo({ title, embedded, iconBuild, sourceDirectory }) {
	...
	const description = embedded
		? `${iconBuild.processedIcons.length} icons generated by <a target="blank" href="https://github.com/npavkovic/svgs-to-icons">svgs-to-icons</a> with embedded SVG data. Load <code>icons.css</code> to display these icons.</p><p class="info">Source: ${sourceDirectory}<br>Output: ${iconBuild.directories.embeddedIcons}`
		: `${iconBuild.processedIcons.length} Icons generated by <a target="blank" href="https://github.com/npavkovic/svgs-to-icons">svgs-to-icons</a> with references to external SVG files. You’ll need both <code>icon.css</code> and the <code>icons</code> directory to display these icons.</p><p class="info">Source: ${sourceDirectory}<br>Output: ${iconBuild.directories.referencedIcons}`;
	...
	const iconItems = iconBuild.processedIcons
		...
		<div class='icon-item' data-name='${icon.displayName.toLowerCase()}' data-class='${
			...
			<div class="icon-wrapper">
				<div class='${icon.className}'role='img' aria-label='${icon.displayName} icon'></div>
			</div>
			<div class="icon-info">
		...
		<div id="control-panel">
			...
			<div class="control-group theme-group">
				...
				<div class="theme-toggle-container">
					...
					<label for="theme-light" aria-label="Switch to light theme">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>
					</label>
					<input type="radio" id="theme-dark" name="theme" value="dark" >
					<label for="theme-dark" aria-label="Switch to dark theme">
	...
	<script>
		(function() {
			...
			function updateDefaultIconColor() {
				...
				if (iconColorDefault.selected) htmlElement.style.setProperty('--icon-color', iconColorDefault.value);
